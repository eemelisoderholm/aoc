...
_warmer_ than it was on Snow Island. It's also quite _humid_. Is this where the
water source is?
...
we'd have, though - this is
_<span title="I find this way funnier than it has any right to be.">Island
Island</span>_, after all! I bet the _gardener_ would know. He's on a different
island, though - er, the small kind surrounded by water, not the floating kind.
We really need to come up with a better naming scheme. Tell you what: if you can
help me with something quick, I'll let you _borrow my boat_ and you can go visit
...
bar (`|`): a list of _winning numbers_ and then a list of _numbers you have_.
...
Take a seat in the large pile of colorful cards. _How many points are they worth
in total?_
...
In total, this example pile of scratchcards causes you to ultimately have _`30`_
scratchcards!
