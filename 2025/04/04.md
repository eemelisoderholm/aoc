...
there's even a massive printer in the corner (to handle the really
<span title="This joke is stupid and I love it.">big</span> print jobs).
...
The forklifts can only access a roll of paper if there are _fewer than four
rolls of paper_ in the eight adjacent positions. If you can figure out which
...
In this example, there are _`13`_ rolls of paper that can be accessed by a
...
Consider your complete diagram of the paper roll locations. _How many rolls of
paper can be accessed by a forklift?_

### Part Two

Now, the Elves just need help accessing as much of the paper as they can.

Once a roll of paper can be accessed by a forklift, it can be _removed_. Once a
roll of paper is removed, the forklifts might be able to access _more_ rolls of
...
many rolls of paper as possible, using highlighted _`@`_ to indicate that a roll
...
a total of _`43`_ rolls of paper can be removed.

Start with your original diagram. _How many rolls of paper in total can be
removed by the Elves and their forklifts?_
