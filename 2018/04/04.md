...
guard post! They've been writing down the ID of _the one guard on duty that
night_ - the Elves seem to have decided that one guard was enough for the
...
_Strategy 1:_ Find the guard that has the most minutes asleep. What minute does
...
(10+10+10). Guard #_10_ was asleep most during minute _24_ (on two days, whereas
